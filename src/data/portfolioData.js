export const portfolioData = {
  ...
  projects: [
    ...
    {
      id: "alpha-gym",
      title: "Alpha Gym — Fitness Club & Workout Management",
      category: "Web Design",
      categories: ["Web Design", "App Design", "UI/UX"],
      badge: "Fitness Platform",
      year: "2025 – 2026",
      shortDescription: "A bold, modern web and mobile application UI designed in Figma for Alpha Gym, featuring membership tiers, workout tracking, and trainer booking.",
      fullDescription: "Alpha Gym is an energetic, performance-focused fitness platform designed with a sleek dark aesthetic. Crafted intuitive user journeys for membership enrollment, personal training schedules, interactive class timetables, and personalized fitness goal tracking.",
      role: "Lead UI/UX & Web Designer",
      duration: "2025 – 2026",
      deliverables: ["Figma UI/UX Design System", "High-Fidelity Wireframes", "Membership Onboarding Flow", "Mobile & Desktop Responsive Layouts"],
      impact: ["Modern High-Energy Dark Aesthetic", "Intuitive Workout & Class Booking", "Component-Based UI Library"],
      ...
      tags: ["Figma", "UI/UX", "Web Design", "App Design", "Fitness UX", "Prototyping"],
